<#
    Assemble the 0.8.3 release pair.
    ...
    Usage:  ./package-release.ps1 [-OutDir <path>] [-Version 0.8.3]
#>
param(
    [string] $OutDir  = "$env:USERPROFILE\Documents\BF6-Release-0.8.3",
...
foreach ($doc in 'LOADOUTS.md','PROJECT-CONTRACT.md','PORTAL-EXPORT.md','LOW-SPEC-TESTING.md','BLOCK-RECOVERY.md','BLOCK-COLORS.md','ATTACHING-AN-AI.md') {
